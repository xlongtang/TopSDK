...
{	
    ...
    /// <summary>
    /// TOP API: ecs.aliyuncs.com.DescribeSnapshots.2014-05-26
    /// </summary>
    public class DescribeSnapshotsRequest : IAliyunRequest<DescribeSnapshotsResponse>
    {
        /// <summary>
        /// 磁盘设备ID
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("SnapshotIds", this.SnapshotIds);
