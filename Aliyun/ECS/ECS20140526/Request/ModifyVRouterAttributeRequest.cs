...
{	
    ...
    /// <summary>
    /// TOP API: ecs.aliyuncs.com.ModifyVRouterAttribute.2014-05-26
    /// </summary>
    public class ModifyVRouterAttributeRequest : IAliyunRequest<ModifyVRouterAttributeResponse>
    {
        /// <summary>
        /// 修改后的虚拟路由器描述
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("VRouterId", this.VRouterId);
            parameters.Add("VRouterName", this.VRouterName);
        ...
        {
            RequestValidator.ValidateRequired("VRouterId", this.VRouterId);
        }
