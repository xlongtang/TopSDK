...
{	
    ...
    /// <summary>
    /// TOP API: ecs.aliyuncs.com.ModifyVSwitchAttribute.2014-05-26
    /// </summary>
    public class ModifyVSwitchAttributeRequest : IAliyunRequest<ModifyVSwitchAttributeResponse>
    {
        /// <summary>
        /// 修改后的虚拟交换机描述
        /// </summary>
        ...
        {
            RequestValidator.ValidateRequired("VSwitchId", this.VSwitchId);
        }
