...
{	
    ...
    /// <summary>
    /// TOP API: mts.aliyuncs.com.QueryTranscodeOutput.2014-06-18
    /// </summary>
    public class QueryTranscodeOutputRequest : IAliyunRequest<QueryTranscodeOutputResponse>
    {
        /// <summary>
        /// 媒资ID
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("TemplateIds", this.TemplateIds);
        ...
        public void Validate()
        {
            ...
            RequestValidator.ValidateRequired("TemplateIds", this.TemplateIds);
        }
