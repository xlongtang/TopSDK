...
{	
    ...
    /// <summary>
    /// TOP API: mts.aliyuncs.com.QueryVideoListByIds.2014-06-18
    /// </summary>
    public class QueryVideoListByIdsRequest : IAliyunRequest<QueryVideoListByIdsResponse>
    {
        /// <summary>
        /// 视频ID列表
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("MediaIds", this.MediaIds);
        ...
        {
            RequestValidator.ValidateRequired("MediaIds", this.MediaIds);
        }
