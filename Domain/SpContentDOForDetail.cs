...
{
    /// <summary>
    /// SpContentDOForDetail Data Structure.
    /// </summary>
    [Serializable]
    public class SpContentDOForDetail : TopObject
    {
        /// <summary>
        /// 类型为文章的内容摘要
        /// </summary>
        ...
        /// <summary>
        /// 内容关联的商品详细信息列表，Json格式的字符串，每个对象包含的信息如下:  1:auctionId 宝贝ID;  2:title 宝贝标题  3:categoryId 宝贝的类目ID  4:price 宝贝价格  5:commission 宝贝淘客价格  6:picUrl 宝贝主图地址  7:picUrls 宝贝所有的普通商品图片  8:detailUrl 宝贝的detail地址
        /// </summary>
        [XmlElement("items")]
