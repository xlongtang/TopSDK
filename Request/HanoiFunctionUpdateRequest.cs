...
{
    /// <summary>
    /// TOP API: taobao.hanoi.function.update
    /// </summary>
    public class HanoiFunctionUpdateRequest : ITopRequest<HanoiFunctionUpdateResponse>
    {
        /// <summary>
        /// 分配给调用方的名称信息，内部统计使用
        /// </summary>
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("function_id", this.FunctionId);
        ...
        public void Validate()
        {
            ...
            RequestValidator.ValidateRequired("function_id", this.FunctionId);
