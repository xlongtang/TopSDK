...
{
    /// <summary>
    /// TOP API: taobao.item.bseller.add
    /// </summary>
    public class ItemBsellerAddRequest : ITopRequest<ItemBsellerAddResponse>
    {
        /// <summary>
        /// 售后服务说明模板id
        /// </summary>
        ...
        /// </summary>
        public string ColorPropAndPicUrls { get; set; }
        ...
        /// </summary>
        public string SubPicUrls { get; set; }
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("color_prop_and_pic_urls", this.ColorPropAndPicUrls);
            ...
            parameters.Add("sub_pic_urls", this.SubPicUrls);
        ...
        {
            RequestValidator.ValidateRequired("auction_point", this.AuctionPoint);
