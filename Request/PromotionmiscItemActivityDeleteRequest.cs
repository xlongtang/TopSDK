...
{
    /// <summary>
    /// TOP API: taobao.promotionmisc.item.activity.delete
    /// </summary>
    public class PromotionmiscItemActivityDeleteRequest : ITopRequest<PromotionmiscItemActivityDeleteResponse>
    {
        /// <summary>
        /// 活动id。
        /// </summary>
