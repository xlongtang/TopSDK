...
{
    /// <summary>
    /// TOP API: taobao.sp.content.update
    /// </summary>
    public class SpContentUpdateRequest : ITopRequest<SpContentUpdateResponse>
    {
        /// <summary>
        /// 内容的主键ID
        /// </summary>
