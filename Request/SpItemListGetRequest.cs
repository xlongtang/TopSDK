...
{
    /// <summary>
    /// TOP API: taobao.sp.item.list.get
    /// </summary>
    public class SpItemListGetRequest : ITopRequest<SpItemListGetResponse>
    {
        /// <summary>
        /// 商品所在地:省名
        /// </summary>
        ...
        /// 30天成交笔数(上限)
        /// </summary>
        public string EndBiz30day { get; set; }
        ...
        /// </summary>
        public string Xfzbz { get; set; }

        /// <summary>
        /// 是否支持正品保障，设置为true表示该商品支持正品保障，设置为false或不设置表示不判断这个属性
        /// </summary>
        public string Zpbz { get; set; }
        ...
        public IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("end_biz30day", this.EndBiz30day);
            ...
            parameters.Add("hdfk", this.Hdfk);
            parameters.Add("jyps", this.Jyps);
            parameters.Add("keyword", this.Keyword);
            parameters.Add("myf", this.Myf);
            parameters.Add("page_no", this.PageNo);
            parameters.Add("page_size", this.PageSize);
            parameters.Add("qtth", this.Qtth);
            parameters.Add("site_key", this.SiteKey);
            parameters.Add("sort", this.Sort);
            parameters.Add("start_biz30day", this.StartBiz30day);
            ...
            parameters.Add("xfzbz", this.Xfzbz);
            parameters.Add("zpbz", this.Zpbz);
