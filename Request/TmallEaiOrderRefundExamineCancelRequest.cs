...
{
    /// <summary>
    /// TOP API: tmall.eai.order.refund.examine.cancel
    /// </summary>
    public class TmallEaiOrderRefundExamineCancelRequest : ITopRequest<TmallEaiOrderRefundExamineCancelResponse>
    {
        /// <summary>
        /// 反审核留言
        /// </summary>
