...
{
    /// <summary>
    /// TOP API: tmall.eai.order.refund.good.return.refuse
    /// </summary>
    public class TmallEaiOrderRefundGoodReturnRefuseRequest : ITopUploadRequest<TmallEaiOrderRefundGoodReturnRefuseResponse>
    {
        /// <summary>
        /// 退款单编号
        /// </summary>
