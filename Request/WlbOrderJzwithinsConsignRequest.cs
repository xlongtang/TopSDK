...
namespace Top.Api.Request
{
    ...
    /// </summary>
    public class WlbOrderJzwithinsConsignRequest : ITopRequest<WlbOrderJzwithinsConsignResponse>
    {
        /// <summary>
        ...
        {
            RequestValidator.ValidateRequired("ins_partner", this.InsPartner);
